...
export default (hit) => {
  ...
  return `<div class="relative aspect-video rounded-md overflow-hidden group cursor-pointer transition-transform duration-200 ease-out hover:scale-105">
      <a href="${url}">
        <img
          src="${hit.backdrop}"
          ...
          width="100%"
        />
        <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-center items-center p-4 text-center">
